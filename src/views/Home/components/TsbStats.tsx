...
import { useTotalSupply, useBurnedBalance } from 'hooks/useTSBTokenBalance'
import useI18n from 'hooks/useI18n'
import { getTsbAddress } from 'utils/addressHelpers'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faQuestionCircle } from '@fortawesome/free-solid-svg-icons'
import ReactTooltip from 'react-tooltip'
import CardValue from './CardValue'
import { useFarms, usePriceTSBBusd } from '../../../state/hooks'
...
const TsbStats = () => {
  ...
  const burnedBalance = useBurnedBalance(getTsbAddress())
  const farms = useFarms()
  const rbtPrice = usePriceTSBBusd()
  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px">New TSB/block</Text>
