      ...
      <Content>
        <div>
          <Block>
            ...
            <Text mb={3}>
              <LiquidityLink href="https://v2exchange.bourbondefi.com/#/add/ETH/0xba26397cdff25f0d26e815d218ef3c77609ae7f1">
                {TranslateString(506, 'Get CAKE-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, Koala DeFi burns the RBT.')}
              <br />
